...
function j(t) {
  ...
  return (
    o
      ? ((h = e === s ? (n - r) / o + 6 * (n < r) : n === s ? (r - e) / o + 2 : (e - n) / o + 4),
        (o /= l < 0.5 ? s + a : 2 - s - a),
        (h *= 60))
      : (o = l > 0 && l < 1 ? 0 : h),
...
function z(t, e, i) {
  return (
    255 *
    (t < 60 ? e + ((i - e) * t) / 60 : t < 180 ? i : t < 240 ? e + ((i - e) * (240 - t)) / 60 : e)
  );
}
(t(i, y, {
  copy(t) {
  ...
  t(
    ...
    e(i, {
      ...
      formatHsl() {
        const t = q(this.opacity);
        return `${1 === t ? "hsl(" : "hsla("}${P(this.h)}, ${100 * S(this.s)}%, ${100 * S(this.l)}%${1 === t ? ")" : `, ${t})`}`;
      },
    })
  ));
const C = Math.PI / 180,
...
function K(t) {
  ...
  if (t instanceof et) return it(t);
  ...
  var e,
    ...
    r = Y(t.g),
    a = Y(t.b),
    s = V((0.2225045 * n + 0.7168786 * r + 0.0606169 * a) / 1);
  return (
    n === r && r === a
      ? (e = i = s)
      : ((e = V((0.4360747 * n + 0.3850649 * r + 0.1430804 * a) / A)),
        (i = V((0.0139322 * n + 0.0971045 * r + 0.7141733 * a) / B))),
    new U(116 * s - 16, 500 * (e - s), 200 * (s - i), t.opacity)
  );
}
function Q(t, e) {
...
function T(t, e, i, n) {
  return 1 === arguments.length ? K(t) : new U(t, e, i, null == n ? 1 : n);
}
function U(t, e, i, n) {
  ((this.l = +t), (this.a = +e), (this.b = +i), (this.opacity = +n));
}
function V(t) {
  return t > J ? Math.pow(t, 1 / 3) : t / G + D;
}
function W(t) {
...
function Z(t) {
  ...
  if ((t instanceof U || (t = K(t)), 0 === t.a && 0 === t.b))
    return new et(NaN, 0 < t.l && t.l < 100 ? 0 : NaN, t.l, t.opacity);
  var e = Math.atan2(t.b, t.a) * L;
  return new et(e < 0 ? e + 360 : e, Math.sqrt(t.a * t.a + t.b * t.b), t.l, t.opacity);
}
function _(t, e, i, n) {
  return 1 === arguments.length ? Z(t) : new et(i, e, t, null == n ? 1 : n);
}
function tt(t, e, i, n) {
  return 1 === arguments.length ? Z(t) : new et(t, e, i, null == n ? 1 : n);
}
function et(t, e, i, n) {
...
function it(t) {
  ...
  var e = t.h * C;
  return new U(t.l, Math.cos(e) * t.c, Math.sin(e) * t.c, t.opacity);
}
(t(
  U,
  T,
  e(i, {
    ...
    rgb() {
      ...
      return new M(
        X(3.1338561 * (e = A * W(e)) - 1.6168667 * (t = 1 * W(t)) - 0.4906146 * (i = B * W(i))),
        X(-0.9787684 * e + 1.9161415 * t + 0.033454 * i),
        X(0.0719453 * e - 0.2289914 * t + 1.4052427 * i),
        this.opacity
      );
    },
  })
  ...
  return 1 === arguments.length
    ? (function (t) {
        ...
        var e = t.r / 255,
          i = t.g / 255,
          n = t.b / 255,
          r = (ut * n + ot * e - lt * i) / (ut + ot - lt),
          a = n - r,
          s = (ht * (i - r) - at * a) / st,
          h = Math.sqrt(s * s + a * a) / (ht * r * (1 - r)),
          o = h ? Math.atan2(s, a) * L - 120 : NaN;
        return new gt(o < 0 ? o + 360 : o, h, r, t.opacity);
      })(t)
    : new gt(t, e, i, null == n ? 1 : n);
}
function gt(t, e, i, n) {
  ((this.h = +t), (this.s = +e), (this.l = +i), (this.opacity = +n));
}
