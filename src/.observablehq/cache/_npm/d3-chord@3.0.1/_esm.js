 ...
 */
import { path as n } from "../d3-path@3.1.0/_esm.js";
var t = Math.abs,
  e = Math.cos,
  r = Math.sin,
  u = Math.PI,
  ...
  function i(i) {
    ...
    f = (v = a(0, o - e * s) / v) ? e : o / s;
    {
      ...
      for (const e of p) {
        const r = t;
        if (n) {
          const n = c(1 + ~s, s).filter((n) => (n < 0 ? i[~n * s + e] : i[e * s + n]));
          u &&
            n.sort((n, t) =>
              u(n < 0 ? -i[~n * s + e] : i[e * s + n], t < 0 ? -i[~t * s + e] : i[e * s + t])
            );
          for (const r of n)
            if (r < 0) {
              (h[~r * s + e] || (h[~r * s + e] = { source: null, target: null })).target = {
                index: e,
                startAngle: t,
              ...
              (h[e * s + r] || (h[e * s + r] = { source: null, target: null })).source = {
                index: e,
                startAngle: t,
          ...
          for (const r of n) {
            ...
            if (
              (e < r
                ? ((n = h[e * s + r] || (h[e * s + r] = { source: null, target: null })),
                  (n.source = {
                    index: e,
                    startAngle: t,
                    endAngle: (t += i[e * s + r] * v),
                ...
                : ((n = h[r * s + e] || (h[r * s + e] = { source: null, target: null })),
                  (n.target = {
                    index: e,
                    startAngle: t,
                    endAngle: (t += i[e * s + r] * v),
  ...
  return (
    u &&
      (M.headRadius = function (n) {
        return arguments.length ? ((u = "function" == typeof n ? n : d(+n)), M) : u;
      }),
    (M.radius = function (n) {
      return arguments.length ? ((c = f = "function" == typeof n ? n : d(+n)), M) : c;
    }),
    (M.sourceRadius = function (n) {
      return arguments.length ? ((c = "function" == typeof n ? n : d(+n)), M) : c;
    }),
    (M.targetRadius = function (n) {
      return arguments.length ? ((f = "function" == typeof n ? n : d(+n)), M) : f;
    }),
    (M.startAngle = function (n) {
      return arguments.length ? ((s = "function" == typeof n ? n : d(+n)), M) : s;
    }),
    (M.endAngle = function (n) {
      return arguments.length ? ((g = "function" == typeof n ? n : d(+n)), M) : g;
    }),
    (M.padAngle = function (n) {
      return arguments.length ? ((p = "function" == typeof n ? n : d(+n)), M) : p;
    }),
    (M.source = function (n) {
...
export { f as chord, g as chordDirected, s as chordTranspose, C as ribbon, q as ribbonArrow };
export default null;
