...
function t(t, i) {
  ...
  var n = (t = i ? t.toExponential(i - 1) : t.toExponential()).indexOf("e"),
    r = t.slice(0, n);
...
var s = {
  ...
  s: function (i, r) {
    var e = t(i, r);
    if (!e) return ((n = void 0), i.toPrecision(r));
    var o = e[0],
      a = e[1],
...
function m(t) {
    ...
    a =
      void 0 === t.grouping || void 0 === t.thousands
        ...
        : ((r = f.call(t.grouping, Number)),
          ...
          function (t, i) {
            for (
              var n = t.length, e = [], a = 0, s = r[0], c = 0;
              n > 0 &&
              s > 0 &&
  ...
  function M(t, i) {
    var r = (t = e(t)).fill,
      ...
      w = t.trim,
      N = t.type;
    ("n" === N ? ((y = !0), (N = "g")) : s[N] || (void 0 === b && (b = 12), (w = !0), (N = "g")),
      (M || ("0" === r && "=" === o)) && ((M = !0), (r = "0"), (o = "=")));
    var S =
        (i && void 0 !== i.prefix ? i.prefix : "") +
        ("$" === f ? h : "#" === f && /[boxX]/.test(N) ? "0" + N.toLowerCase() : ""),
      k = ("$" === f ? u : /[%p]/.test(N) ? g : "") + (i && void 0 !== i.suffix ? i.suffix : ""),
      z = s[N],
      A = /[defgprs%]/.test(N);
    function j(t) {
      var i,
      ...
      if ("c" === N) ((u = z(t) + u), (t = ""));
        ...
        if (
          ...
          (h = (f ? ("(" === c ? c : p) : "-" === c || "(" === c ? "" : c) + h),
          (u =
            ("s" !== N || isNaN(t) || void 0 === n ? "" : d[8 + n / 3]) +
            u +
            (f && "(" === c ? ")" : "")),
          A)
        )
          for (i = -1, e = t.length; ++i < e; )
            if (48 > (s = t.charCodeAt(i)) || s > 57) {
              ((u = (46 === s ? l + t.slice(i + 1) : t.slice(i)) + u), (t = t.slice(0, i)));
              break;
            }
      }
      y && !M && (t = a(t, 1 / 0));
      var g = h.length + t.length + u.length,
        j = g < x ? new Array(x - g + 1).join(r) : "";
      switch ((y && M && ((t = a(j + t, j.length ? x - u.length : 1 / 0)), (j = "")), o)) {
        case "<":
          t = h + t + u + j;
          break;
        case "=":
          ...
          break;
        case "^":
          t = j.slice(0, (g = j.length >> 1)) + h + t + u + j.slice(g);
          break;
        default:
          t = j + h + t + u;
      }
  ...
  return {
    ...
    formatPrefix: function (t, n) {
      var r = 3 * Math.max(-8, Math.min(8, Math.floor(i(n) / 3))),
        o = Math.pow(10, -r),
        a = M((((t = e(t)).type = "f"), t), { suffix: d[8 + r / 3] });
      return function (t) {
        return a(o * t);
      };
    },
...
function g(t) {
  return ((h = m(t)), (u = h.format), (l = h.formatPrefix), h);
}
function p(t) {
