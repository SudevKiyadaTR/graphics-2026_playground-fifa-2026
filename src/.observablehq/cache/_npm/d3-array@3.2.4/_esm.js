 ...
 */
import { InternMap as t, InternSet as n } from "../internmap@2.0.3/_esm.js";
export { InternMap, InternSet } from "../internmap@2.0.3/_esm.js";
function r(t, n) {
    ...
    return (function (t) {
      ...
      return (r, o, e, f, i) => {
        ...
        for (let t = e, c = f; t <= c; t += i)
          ((u += o[Math.min(f, t + l)]), (r[t] = u / n), (u -= o[Math.max(e, t - l)]));
      };
    })(t);
  const r = t - n,
    o = 2 * t + 1;
...
function N(t, n) {
  ...
  if (void 0 === n)
    for (let n of t)
      null != n && (n = +n) >= n && ((r = n - e), (e += r / ++o), (f += r * (n - e)));
  else {
    let i = -1;
    for (let u of t)
      null != (u = n(u, ++i, t)) &&
...
function T(t, n) {
  ...
  if (void 0 === n)
    ...
    for (let f of t)
      null != (f = n(f, ++e, t)) &&
        (void 0 === r ? f >= f && (r = o = f) : (r > f && (r = f), o < f && (o = f)));
  }
  return [r, o];
}
class F {
  ...
  valueOf() {
    ...
    let n,
      ...
      f = 0;
    if (e > 0) {
      for (f = t[--e]; e > 0 && ((n = f), (r = t[--e]), (f = n + r), (o = r - (f - n)), !o); );
      e > 0 &&
...
function et() {
  ...
  function o(o) {
    ...
    if (isFinite(i)) {
      ...
      for (e = 0; e < u; ++e) null != (f = c[e]) && s <= f && f <= h && v[l(y, f, 0, d)].push(o[e]);
    return v;
  }
  return (
    (o.value = function (n) {
      return arguments.length ? ((t = "function" == typeof n ? n : V(n)), o) : t;
    }),
    (o.domain = function (t) {
      return arguments.length ? ((n = "function" == typeof t ? t : V([t[0], t[1]])), o) : n;
    }),
    (o.thresholds = function (t) {
      return arguments.length
        ? ((r = "function" == typeof t ? t : V(Array.isArray(t) ? Q.call(t) : t)), o)
        : r;
    }),
    o
  );
...
function ft(t, n) {
  ...
  if (void 0 === n) for (const n of t) null != n && (r < n || (void 0 === r && n >= n)) && (r = n);
    ...
    let o = -1;
    for (let e of t) null != (e = n(e, ++o, t)) && (r < e || (void 0 === r && e >= e)) && (r = e);
  }
  return r;
}
function it(t, n) {
  ...
  if (void 0 === n)
    for (const n of t)
      (++e, null != n && (r < n || (void 0 === r && n >= n)) && ((r = n), (o = e)));
  else
    for (let f of t)
      null != (f = n(f, ++e, t)) && (r < f || (void 0 === r && f >= f)) && ((r = f), (o = e));
  return o;
}
function ut(t, n) {
  let r;
...
function st(t, n = r) {
  ...
  } else for (const r of t) (e ? n(r, o) > 0 : 0 === n(r, r)) && ((o = r), (e = !0));
  return o;
}
function ht(t, n, r) {
  if (
    ((t = Float64Array.from(
      (function* (t, n) {
        if (void 0 === n) for (let n of t) null != n && (n = +n) >= n && (yield n);
          ...
          let r = -1;
          for (let o of t) null != (o = n(o, ++r, t)) && (o = +o) >= o && (yield o);
        }
      })(t, r)
    )),
...
function dt(t, n, r = i) {
  if (!isNaN((n = +n))) {
    if (((o = Float64Array.from(t, (n, o) => i(r(t[o], o, t)))), n <= 0)) return lt(o);
    if (n >= 1) return it(o);
    var o,
...
function Mt(t, n) {
  let r = 0,
    o = 0;
  if (void 0 === n) for (let n of t) null != n && (n = +n) >= n && (++r, (o += n));
  else {
    let e = -1;
    for (let f of t) null != (f = n(f, ++e, t)) && (f = +f) >= f && (++r, (o += f));
  }
  if (r) return o / r;
}
function vt(t, n) {
...
function At(n, r) {
  const o = new t();
  if (void 0 === r) for (let t of n) null != t && t >= t && o.set(t, (o.get(t) || 0) + 1);
  else {
    let t = -1;
    for (let e of n) null != (e = r(e, ++t, n)) && e >= e && o.set(e, (o.get(e) || 0) + 1);
  }
  let e,
    f = 0;
...
function Nt(t, n, r) {
  ...
  for (var o = -1, e = 0 | Math.max(0, Math.ceil((n - t) / r)), f = new Array(e); ++o < e; )
    f[o] = t + o * r;
  return f;
}
function Et(t, n = r) {
  ...
  let i, u;
  return (
    (t = Uint32Array.from(o, (t, n) => n)).sort(n === r ? (t, n) => K(o[t], o[n]) : J(f)),
    t.forEach((t, n) => {
      const r = f(t, void 0 === i ? t : i);
      r >= 0 ? ((void 0 === i || r > 0) && ((i = t), (u = n)), (e[t] = u)) : (e[t] = NaN);
    }),
    e
  );
}
...
function Ft(t, n = r) {
  ...
  let o,
    e = -1,
    f = -1;
  for (const r of t) (++f, (e < 0 ? 0 === n(r, r) : n(r, o) < 0) && ((o = r), (e = f)));
  return e;
}
function St(t, n = r) {
