...
var v = (function n(r) {
  ...
  function a(n, r) {
    ...
    return function (t) {
      return ((n.r = a(t)), (n.g = o(t)), (n.b = u(t)), (n.opacity = i(t)), n + "");
    };
  }
  return ((a.gamma = n), a);
})(1);
...
function V(t) {
  return function (n, e) {
    ...
    return function (t) {
      return ((n.h = a(t)), (n.s = o(t)), (n.l = u(t)), (n.opacity = i(t)), n + "");
    };
  };
}
var Q = V(f),
...
function W(t) {
  return function (n, r) {
    var e = t((n = a(n)).h, (r = a(r)).h),
      ...
      i = p(n.opacity, r.opacity);
    return function (t) {
      return ((n.h = e(t)), (n.c = o(t)), (n.l = u(t)), (n.opacity = i(t)), n + "");
    };
  };
}
var Z = W(f),
...
function F(t) {
  return (function n(r) {
    function e(n, e) {
      ...
      return function (t) {
        return ((n.h = a(t)), (n.s = u(t)), (n.l = i(Math.pow(t, r))), (n.opacity = c(t)), n + "");
      };
    }
...
function U(t, n) {
  void 0 === n && ((n = t), (t = R));
  for (var r = 0, e = n.length - 1, a = n[0], o = new Array(e < 0 ? 0 : e); r < e; )
    o[r] = t(a, (a = n[++r]));
  return function (t) {
