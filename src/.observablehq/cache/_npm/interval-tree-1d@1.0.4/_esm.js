 ...
 */
import t from "../binary-search-bounds@2.0.5/_esm.js";
var i = t,
  r = function (t) {
...
((s.intervals = function (t) {
    ...
    for (
      ...
      if (this.leftPoints[e] === t) {
        ...
        for (
          ...
          if (this.rightPoints[o] === t) return (this.rightPoints.splice(o, 1), 1);
      }
    return 0;
  }),
  ...
  (s.queryInterval = function (t, i, r) {
    var n;
    if (t < this.mid && this.left && (n = this.left.queryInterval(t, i, r))) return n;
    if (i > this.mid && this.right && (n = this.right.queryInterval(t, i, r))) return n;
    return i < this.mid
...
var p = m.prototype;
((p.insert = function (t) {
  this.root ? this.root.insert(t) : (this.root = new n(t[0], null, null, [t], [t]));
}),
  (p.remove = function (t) {
    if (this.root) {
