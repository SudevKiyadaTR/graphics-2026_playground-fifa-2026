...
import {
  ...
  utcTicks as T,
} from "../d3-time@3.1.0/_esm.js";
import { timeFormat as Q, utcFormat as U } from "../d3-time-format@4.1.0/_esm.js";
function B(n, t) {
...
function j() {
  ...
  return (
    ...
    (e.range = function (n) {
      return arguments.length ? (([o, i] = n), (o = +o), (i = +i), p()) : [o, i];
    }),
...
function Z(n, t, e) {
  var u = Math.min(n.length, t.length) - 1,
    ...
    o = new Array(u),
    i = -1;
  for (n[u] < n[0] && ((n = n.slice().reverse()), (t = t.slice().reverse())); ++i < u; )
...
function _() {
  ...
  function g(t) {
    return null == t || isNaN((t = +t)) ? r : (u || (u = e(o.map(n), i, c)))(n(p(t)));
  }
  return (
    (g.invert = function (r) {
...
function tn(n, t, r, u) {
  ...
  switch ((u = h(null == u ? ",f" : u)).type) {
    case "s":
      ...
      return (null != u.precision || isNaN((a = d(o, i))) || (u.precision = a), y(u, i));
    case "":
    case "e":
    case "g":
    case "p":
    ...
    case "f":
    case "%":
      null != u.precision || isNaN((a = g(o))) || (u.precision = a - 2 * ("%" === u.type));
  }
  return v(u);
}
function rn(n) {
  ...
  return (
    ...
    (n.nice = function (r) {
      ...
      var e,
        ...
        f = o[c],
        s = 10;
      for (f < l && ((u = l), (l = f), (f = u), (u = i), (i = c), (c = u)); s-- > 0; ) {
...
function hn(n) {
  ...
  return (
    ...
    (t.nice = () =>
      r(an(r(), { floor: (n) => a(Math.floor(e(n))), ceil: (n) => a(Math.ceil(e(n))) }))),
    t
  );
}
function gn() {
...
function qn() {
  ...
  return (
    ...
    (u.range = function (n) {
      return arguments.length ? (t.range((r = Array.from(n, J)).map(An)), u) : r.slice();
    }),
...
function Sn() {
  ...
  return (
    (c.invertExtent = function (n) {
      var r = e.indexOf(n);
      return r < 0 ? [NaN, NaN] : [r > 0 ? u[r - 1] : t[0], r < u.length ? u[r] : t[t.length - 1]];
    }),
    (c.domain = function (n) {
...
function Dn() {
  ...
  function c() {
    var n = -1;
    for (a = new Array(u); ++n < u; ) a[n] = ((n + 1) * e - (n - u) * t) / (u + 1);
    return i;
  }
  return (
    (i.domain = function (n) {
      return arguments.length ? (([t, e] = n), (t = +t), (e = +e), c()) : [t, e];
    }),
    (i.range = function (n) {
      return arguments.length ? ((u = (o = Array.from(n)).length - 1), c()) : o.slice();
    }),
    (i.invertExtent = function (n) {
      var r = o.indexOf(n);
      return r < 0 ? [NaN, NaN] : r < 1 ? [t, a[0]] : r >= u ? [a[u - 1], e] : [a[r - 1], a[r]];
    }),
...
function En(n, t, r, e, u, a, o, i, c, l) {
  ...
  return (
    ...
    (f.nice = function (n) {
      var r = p();
      return (
        (n && "function" == typeof n.range) || (n = t(r[0], r[r.length - 1], null == n ? 10 : n)),
        n ? p(an(r, n)) : f
      );
    }),
    (f.copy = function () {
...
function Ln() {
  return B.apply(
    En(S, q, A, b, x, N, k, w, M, Q).domain([new Date(2e3, 0, 1), new Date(2e3, 0, 2)]),
    arguments
  );
}
function Fn() {
  return B.apply(
    En(T, P, F, L, E, R, O, I, D, U).domain([Date.UTC(2e3, 0, 1), Date.UTC(2e3, 0, 2)]),
    arguments
  );
}
function Pn() {
  ...
  function l(t) {
    return null == t || isNaN((t = +t))
      ? u
      : i(0 === r ? 0.5 : ((t = (e(t) - n) * r), c ? Math.max(0, Math.min(1, t)) : t));
  }
  function p(n) {
    return function (t) {
      var r, e;
  ...
  return (
    (l.domain = function (u) {
      return arguments.length
        ? (([a, o] = u), (n = e((a = +a))), (t = e((o = +o))), (r = n === t ? 0 : 1 / (t - n)), l)
        : [a, o];
    }),
    (l.clamp = function (n) {
    ...
    function (u) {
      return ((e = u), (n = u(a)), (t = u(o)), (r = n === t ? 0 : 1 / (t - n)), l);
    }
  );
}
function Tn(n, t) {
...
function Yn() {
  var n = [],
    t = V;
  function e(e) {
    if (null != e && !isNaN((e = +e))) return t((r(n, e, 1) - 1) / (n.length - 1));
  }
  return (
    (e.domain = function (t) {
...
function jn() {
  ...
  function y(n) {
    return function (t) {
      var r, e, u;
      return arguments.length ? (([r, e, u] = t), (g = p(n, [r, e, u])), d) : [g(0), g(0.5), g(1)];
    };
  }
  return (
    (d.domain = function (o) {
