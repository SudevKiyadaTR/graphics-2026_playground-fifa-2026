...
function h(r, n) {
  for (var t = n[0], o = n[1], e = -1, i = 0, u = r.length, a = u - 1; i < u; a = i++) {
    var f = r[i],
      c = f[0],
      h = f[1],
      l = r[a],
  ...
  function E(r, n) {
    ...
    return (
      (function (r, n, t) {
        ...
        for (; ++o < e - 1; ) ((a = f), (f = p(r[o + 1], n)), d[a | (f << 1)].forEach(g));
        d[f | 0].forEach(g);
        for (; ++u < i - 1; ) {
          for (
            o = -1, f = p(r[u * e + e], n), c = p(r[u * e], n), d[(f << 1) | (c << 2)].forEach(g);
            ++o < e - 1;
          )
            ((a = f),
              (f = p(r[u * e + e + o + 1], n)),
        ...
        for (; ++o < e - 1; )
          ((h = c), (c = p(r[u * e + o + 1], n)), d[(c << 2) | (h << 3)].forEach(g));
        function g(r) {
          var n,
            e,
            i = [r[0][0] + o, r[0][1] + u],
        ...
        (s(n, r, t),
          (function (r) {
            for (
              var n = 0, t = r.length, o = r[t - 1][1] * r[0][0] - r[t - 1][0] * r[0][1];
              ++n < t;
            )
  ...
  return (
    ...
    (g.thresholds = function (r) {
      return arguments.length
        ? ((h = "function" == typeof r ? r : Array.isArray(r) ? f(u.call(r)) : f(r)), g)
        : h;
    }),
    (g.smooth = function (r) {
...
function N() {
  ...
  return (
    ...
    (w.x = function (n) {
      return arguments.length ? ((r = "function" == typeof n ? n : f(+n)), w) : r;
    }),
    (w.y = function (r) {
      return arguments.length ? ((n = "function" == typeof r ? r : f(+r)), w) : n;
    }),
    (w.weight = function (r) {
      return arguments.length ? ((o = "function" == typeof r ? r : f(+r)), w) : o;
    }),
    (w.size = function (r) {
    ...
    (w.thresholds = function (r) {
      return arguments.length
        ? ((p = "function" == typeof r ? r : Array.isArray(r) ? f(u.call(r)) : f(r)), w)
        : p;
    }),
