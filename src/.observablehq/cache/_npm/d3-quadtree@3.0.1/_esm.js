...
function t(t, i, r, n) {
  ...
  for (; x.length; )
    if (
      ...
      return ((e[_] = c), t);
  if (((o = +t._x.call(null, x.data)), (a = +t._y.call(null, x.data)), i === o && r === a))
...
function s(t) {
  for (var i = { data: t.data }, r = i; (t = t.next); ) r = r.next = { data: t.data };
  return i;
}
...
((o.copy = function () {
  ...
  (o.addAll = function (i) {
    ...
    for (this.cover(u, l).cover(_, f), n = 0; n < s; ++n) t(this, o[n], a[n], i[n]);
    return this;
  }),
  (o.cover = function (t, i) {
    ...
    if (isNaN(r)) ((e = (r = Math.floor(t)) + 1), (h = (n = Math.floor(i)) + 1));
      ...
      for (var s, o, a = e - r || 1, u = this._root; r > t || t >= e || n > i || i >= h; )
        switch (
          ((o = ((i < n) << 1) | (t < r)), ((s = new Array(4))[o] = u), (u = s), (a *= 2), o)
        ) {
          case 0:
            ((e = r + a), (h = n + a));
            break;
  ...
  (o.find = function (t, r, n) {
    ...
    for (
      v && y.push(new i(v, _, f, x, c)),
        null == n ? (n = 1 / 0) : ((_ = t - n), (f = r - n), (x = t + n), (c = r + n), (n *= n));
      (u = y.pop());
    )
      if (!(!(v = u.node) || (h = u.x0) > x || (s = u.y0) > c || (o = u.x1) < _ || (a = u.y1) < f))
        if (v.length) {
          var d = (h + o) / 2,
            p = (s + a) / 2;
          (y.push(
  ...
  (o.remove = function (t) {
    if (isNaN((h = +this._x.call(null, t))) || isNaN((s = +this._y.call(null, t)))) return this;
    var i,
      r,
      n,
      e,
    ...
    if (x.length)
      for (;;) {
        if (
          ...
          return this;
        if (!x.length) break;
        (i[(_ + 1) & 3] || i[(_ + 2) & 3] || i[(_ + 3) & 3]) && ((r = i), (f = _));
      }
  ...
  (o.visit = function (t) {
    var r,
      ...
      a = [],
      u = this._root;
    for (u && a.push(new i(u, this._x0, this._y0, this._x1, this._y1)); (r = a.pop()); )
      if (!t((u = r.node), (e = r.x0), (h = r.y0), (s = r.x1), (o = r.y1)) && u.length) {
        var l = (e + s) / 2,
          _ = (h + o) / 2;
