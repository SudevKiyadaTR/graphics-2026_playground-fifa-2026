 ...
 */
import { Adder as n, merge as t, range as r } from "../d3-array@3.2.4/_esm.js";
var i = 1e-6,
  e = 1e-12,
  o = Math.PI,
  u = o / 2,
...
var A = {
    ...
    FeatureCollection: function (n, t) {
      for (var r = n.features, i = -1, e = r.length; ++i < e; ) P(r[i].geometry, t);
    },
  },
  $ = {
    Sphere: function (n, t) {
    ...
    MultiLineString: function (n, t) {
      for (var r = n.coordinates, i = -1, e = r.length; ++i < e; ) q(r[i], t, 0);
    },
...
var L,
  ...
  Q = {
    ...
    polygonEnd: function () {
      var n = +J;
      (K.add(n < 0 ? c + n : n), (this.lineStart = this.lineEnd = this.point = C));
    },
    sphere: function () {
      K.add(c);
    },
...
function tn(n, t) {
  ((Q.point = rn), (L = n), (b = t), (G = n *= f), (O = g((t = (t *= f) / 2 + a))), (T = m(t)));
}
function rn(n, t) {
  var r = (n *= f) - G,
    i = r >= 0 ? 1 : -1,
...
var pn,
  ...
  Pn = {
    ...
    lineEnd: zn,
    polygonStart: function () {
      ((Pn.point = jn), (Pn.lineStart = Ln), (Pn.lineEnd = bn), (D = new n()), Q.polygonStart());
    },
    polygonEnd: function () {
      (Q.polygonEnd(),
        (Pn.point = An),
        (Pn.lineStart = qn),
        (Pn.lineEnd = zn),
        J < 0 ? ((k = -(H = 180)), (F = -(I = 90))) : D > i ? (I = 90) : D < -i && (F = -90),
        (Z[0] = k),
        (Z[1] = H));
    },
    sphere: function () {
...
function bn() {
  (jn(X, Y), Q.lineEnd(), s(D) > i && (k = -(H = 180)), (Z[0] = k), (Z[1] = H), (B = null));
}
function Gn(n, t) {
...
function Xn(n, t) {
  n *= f;
  var r = g((t *= f));
  ((Nn = r * g(n)), (Rn = r * m(n)), (Cn = m(t)), (Fn.point = Yn), In(Nn, Rn, Cn));
}
function Yn(n, t) {
  n *= f;
  var r = g((t *= f)),
    ...
    o = m(t),
    u = h(
      w((u = Rn * o - Cn * e) * u + (u = Cn * i - Nn * o) * u + (u = Nn * e - Rn * i) * u),
      Nn * i + Rn * e + Cn * o
    );
  ((hn += u),
    (En += u * (Nn + (Nn = i))),
...
function Kn(t) {
  ...
  var r = +mn,
    ...
    a = E(r, o, u);
  return a < e &&
    ((r = En), (o = yn), (u = Sn), hn < i && ((r = gn), (o = vn), (u = dn)), (a = E(r, o, u)) < e)
    ? [NaN, NaN]
    : [h(o, r) * l, N(u / a) * l];
}
function Qn(n) {
...
function tt(n, t, r) {
  return (n %= c) ? (t || r ? Vn(it(n), et(t, r)) : it(n)) : t || r ? et(t, r) : nt;
}
function rt(n) {
  return function (t, r) {
...
function ut(n, t, r, i, e, o) {
  if (r) {
    ...
    null == e
      ? ((e = t + i * c), (o = t - l / 2))
      : ((e = at(u, e)), (o = at(u, o)), (i > 0 ? e < o : e > o) && (e += i * c));
  ...
  if (
    (n.forEach(function (n) {
      if (!((t = n.length - 1) <= 0)) {
        ...
        (a.push((r = new st(i, n, null, !0))),
          c.push((r.o = new st(i, null, r, !1))),
          a.push((r = new st(u, n, null, !1))),
          c.push((r.o = new st(u, null, r, !0))));
      }
    }),
    a.length)
  ) {
    for (c.sort(t), ht(a), ht(c), o = 0, u = c.length; o < u; ++o) c[o].e = r = !r;
    for (var l, f, s = a[0]; ; ) {
...
function vt(t, r) {
  var e = gt(r),
    ...
    d = new n();
  1 === f ? (l = u + i) : -1 === f && (l = -u - i);
  for (var E = 0, y = t.length; E < y; ++E)
    if ((M = (S = t[E]).length))
      for (
        var S, M, w = S[M - 1], x = gt(w), _ = w[1] / 2 + a, R = m(_), C = g(_), P = 0;
        P < M;
        ++P, x = $, R = z, C = j, w = A
      ) {
        var A = S[P],
        ...
        if (
          ...
          var F = cn(s, k);
          sn(F);
          var H = (O ^ (L >= 0) ? -1 : 1) * N(F[2]);
          (l > H || (l === H && (k[0] || k[1]))) && (v += O ^ (L >= 0) ? 1 : -1);
        }
      }
  return (p < -i || (p < i && d < -1e-12)) ^ (1 & v);
}
function dt(n, r, i, e) {
  return function (o) {
    var u,
      ...
      h = {
        ...
        polygonEnd: function () {
          ...
          (a.length
            ...
            : n &&
              (p || (o.polygonStart(), (p = !0)), o.lineStart(), i(null, null, 1, o), o.lineEnd()),
            p && (o.polygonEnd(), (p = !1)),
            (a = u = null));
        },
        sphere: function () {
    ...
    function m() {
      ...
      if ((c.pop(), u.push(c), (c = null), h))
        ...
        } else (h > 1 && 2 & e && l.push(l.pop().concat(l.shift())), a.push(l.filter(Et)));
    }
    return h;
  };
}
...
function yt(n, t) {
  return (
    ((n = n.x)[0] < 0 ? n[1] - u - i : u - n[1]) - ((t = t.x)[0] < 0 ? t[1] - u - i : u - t[1])
  );
}
nt.invert = nt;
var St = dt(
          ...
          : a !== f &&
            ...
            (e = (function (n, t, r, e) {
              var o,
                ...
                a = m(n - r);
              return s(a) > i
                ? p((m(t) * (u = g(e)) * m(r) - m(e) * (o = g(t)) * m(n)) / (o * u * a))
                : (t + e) / 2;
            })(r, e, c, l)),
            n.point(a, e),
            n.lineEnd(),
    ...
    function (n) {
      ...
      return {
        ...
        point: function (p, h) {
          ...
          (!d || (t && ft(t, v)) || n.point(v[0], v[1]), (t = v), (i = d), (r = E));
        },
        lineEnd: function () {
          (i && n.lineEnd(), (t = null));
        },
...
function Ct(n, r, e, o) {
  ...
  return function (i) {
        ...
        polygonEnd: function () {
          var r = (function () {
              for (var t = 0, r = 0, i = f.length; r < i; ++r)
                for (
                  var e, u, a = f[r], c = 1, l = a.length, s = a[0], p = s[0], h = s[1];
                  c < l;
                  ++c
                )
                  ((e = p),
    ...
    function _(t, i) {
      var a = u(t, i);
      if ((f && s.push([t, i]), y))
        ((p = t), (h = i), (g = a), (y = !1), a && (m.lineStart(), m.point(t, i)));
      else if (a && E) m.point(t, i);
      else {
        var c = [(v = Math.max(Rt, Math.min(Nt, v))), (d = Math.max(Rt, Math.min(Nt, d)))],
          l = [(t = Math.max(Rt, Math.min(Nt, t))), (i = Math.max(Rt, Math.min(Nt, i)))];
  ...
  return (r = {
    ...
    extent: function (a) {
      return arguments.length
        ? ((i = +a[0][0]), (e = +a[0][1]), (o = +a[1][0]), (u = +a[1][1]), (n = t = null), r)
        : [
            [i, e],
            [o, u],
          ];
...
var Ot = {
    ...
    FeatureCollection: function (n, t) {
      for (var r = n.features, i = -1, e = r.length; ++i < e; ) if (kt(r[i].geometry, t)) return !0;
      return !1;
    },
  },
  Tt = {
    ...
    MultiPolygon: function (n, t) {
      for (var r = n.coordinates, i = -1, e = r.length; ++i < e; ) if (It(r[i], t)) return !0;
      return !1;
    },
    GeometryCollection: function (n, t) {
      for (var r = n.geometries, i = -1, e = r.length; ++i < e; ) if (kt(r[i], t)) return !0;
      return !1;
    },
  };
function kt(n, t) {
...
function Ut() {
  ...
  return (
    ...
    (M.outline = function () {
      return {
        type: "Polygon",
        coordinates: [h(o).concat(g(c).slice(1), h(e).reverse().slice(1), g(l).reverse().slice(1))],
      };
    }),
    (M.extent = function (n) {
...
function qr(n, t) {
  var r = n - dr,
    i = t - Er,
    e = w(r * r + i * i);
  ((Mr += (e * (dr + n)) / 2), (wr += (e * (Er + t)) / 2), (xr += e), Pr((dr = n), (Er = t)));
}
function zr() {
  Cr.point = Pr;
}
  ...
  point: function (n, t) {
    switch (this._point) {
      ...
      case 1:
        ...
        break;
      default:
        (this._context.moveTo(n + this._radius, t), this._context.arc(n, t, this._radius, 0, c));
    }
  },
  result: C,
};
  ...
  point(n, t) {
    switch (this._point) {
      ...
      case 1:
        ...
        break;
      default:
        if ((this._append`M${n},${t}`, this._radius !== Zr || this._append !== Ur)) {
          const n = this._radius,
            t = this._;
          ((this._ = ""),
            this._append`m0,${n}a${n},${n} 0 1,1 0,${-2 * n}a${n},${n} 0 1,1 0,${2 * n}z`,
            (Zr = n),
            (Ur = this._append),
            (Jr = this._),
            (this._ = t));
...
function Vr(n, t) {
  ...
  function u(n) {
    return (
      n && ("function" == typeof o && i.pointRadius(+o.apply(this, arguments)), j(n, r(i))),
      i.result()
    );
  }
  return (
    ...
    (u.projection = function (t) {
      return arguments.length ? ((r = null == t ? ((n = null), tr) : (n = t).stream), u) : n;
    }),
    ...
    (u.pointRadius = function (n) {
      return arguments.length ? ((o = "function" == typeof n ? n : (i.pointRadius(+n), +n)), u) : o;
    }),
    (u.digits = function (n) {
  ...
  return +t
    ? (function (n, t) {
        function r(e, o, u, a, c, l, f, p, g, v, d, E, y, S) {
          ...
          if (x > 4 * t && y--) {
            var _ = a + v,
              ...
              b = j - o,
              G = M * L - m * b;
            ((G * G) / x > t || s((m * L + M * b) / x - 0.5) > 0.3 || a * v + c * d + l * E < ci) &&
        ...
        return function (t) {
          ...
          function M(n, t) {
            (y((i = n), t), (e = f), (o = s), (u = p), (a = h), (c = g), (v.point = y));
          }
          function w() {
            (r(f, s, l, p, h, g, e, o, i, u, a, c, 16, t), (v.lineEnd = S), S());
          }
          return v;
        };
      })(n, t)
...
function hi(n) {
  ...
  function z() {
    var n = si(h, 0, 0, x, _, M).apply(null, t(d, E)),
      i = si(h, g - n[0], v - n[1], x, _, M);
    return ((r = tt(y, S, m)), (a = Vn(t, i)), (c = Vn(r, a)), (u = li(a, A)), j());
  }
  function j() {
    return ((s = p = null), $);
  }
  return (
    ...
    ($.clipAngle = function (n) {
      return arguments.length ? ((R = +n ? mt((N = n * f)) : ((N = null), St)), j()) : N * l;
    }),
    ($.clipExtent = function (n) {
      return arguments.length
        ? ((P =
            null == n
              ? ((C = i = e = o = null), tr)
              : Ct((C = +n[0][0]), (i = +n[0][1]), (e = +n[1][0]), (o = +n[1][1]))),
          j())
        : null == C
          ? null
          : [
    ...
    ($.precision = function (n) {
      return arguments.length ? ((u = li(a, (A = n * n))), j()) : w(A);
    }),
...
function gi(n) {
  ...
  return (
    (e.parallels = function (n) {
      return arguments.length ? i((t = n[0] * f), (r = n[1] * f)) : [t * l, r * l];
    }),
    e
  );
}
...
function di() {
  return gi(vi).scale(155.424).center([0, 33.6442]);
}
function Ei() {
  return di()
    .parallels([29.5, 45.5])
...
function yi() {
  var n,
    ...
    u,
    a = Ei(),
    c = di().rotate([154, 0]).center([-2, 58.5]).parallels([55, 65]),
    l = di().rotate([157, 0]).center([-3, 19.9]).parallels([8, 18]),
    f = {
      point: function (n, t) {
        u = [n, t];
      },
  ...
  function s(n) {
    var t = n[0],
      i = n[1];
    return ((u = null), r.point(t, i), u || (e.point(t, i), u) || (o.point(t, i), u));
  }
  function p() {
    return ((n = t = null), s);
  }
  return (
    ...
    (s.scale = function (n) {
      return arguments.length
        ? (a.scale(n), c.scale(0.35 * n), l.scale(n), s.translate(a.translate()))
        : a.scale();
    }),
...
var Mi = Si(function (n) {
  return w(2 / (1 + n));
});
function wi() {
  return pi(Mi).scale(124.75).clipAngle(179.999);
}
Mi.invert = mi(function (n) {
  return 2 * N(n / 2);
});
var xi = Si(function (n) {
  return (n = _(n)) && n / m(n);
});
function _i() {
  return pi(xi).scale(79.4188).clipAngle(179.999);
}
function Ni(n, t) {
  return [n, y(x((u + t) / 2))];
}
function Ri() {
  return Ci(Ni).scale(961 / c);
}
function Ci(n) {
  var t,
    r,
  ...
  return (
    (c.invert = function (n, t) {
      var r = a - t,
        i = M(e) * w(n * n + r * r),
        c = h(n, s(r)) * M(r);
      return (r * e < 0 && (c -= o * M(n) * M(r)), [c / e, 2 * p(S(a / i, 1 / e)) - u]);
    }),
    c
  );
}
function $i() {
  return gi(Ai).scale(109.5).parallels([30, 30]);
}
function qi(n, t) {
  return [n, t];
}
function zi() {
  return pi(qi).scale(152.63);
}
function ji(n, t) {
  var r = g(n),
    e = n === t ? m(n) : (r - g(t)) / (t - n),
  ...
  return (
    (a.invert = function (n, t) {
      var r = u - t,
        i = h(n, s(r)) * M(r);
      return (r * e < 0 && (i -= o * M(n) * M(r)), [i / e, u - M(e) * w(n * n + r * r)]);
    }),
    a
  );
}
function Li() {
  return gi(ji).scale(131.154).center([0, 13.9389]);
}
((xi.invert = mi(function (n) {
  return n;
})),
...
function Fi(n, t) {
  var r = N(ki * m(t)),
    ...
    e = i * i * i;
  return [
    (n * g(r)) / (ki * (bi + 3 * Gi * i + e * (7 * Oi + 9 * Ti * i))),
    r * (bi + Gi * i + e * (Oi + Ti * i)),
  ];
}
function Hi() {
  return pi(Fi).scale(177.158);
}
function Ii(n, t) {
  var r = g(t),
    i = g(n) * r;
...
function Wi() {
  return pi(Ii).scale(144.049).clipAngle(60);
}
function Xi() {
  var n,
    t,
  ...
  return (
    ...
    (x.clipExtent = function (n) {
      return arguments.length
        ? ((M =
            null == n
              ? ((d = r = i = e = null), tr)
              : Ct((d = +n[0][0]), (r = +n[0][1]), (i = +n[1][0]), (e = +n[1][1]))),
          w())
        : null == d
          ? null
          : [
    ...
    (x.angle = function (r) {
      return arguments.length ? ((t = m((v = (r % 360) * f))), (n = g(v)), w()) : v * l;
    }),
...
function Bi() {
  return pi(Yi).scale(175.295);
}
function Di(n, t) {
  return [g(t) * m(n), m(t)];
}
function Ui() {
  return pi(Di).scale(249.5).clipAngle(90.000001);
}
function Zi(n, t) {
  var r = g(t),
    i = 1 + g(n) * r;
...
function Ji() {
  return pi(Zi).scale(250).clipAngle(142);
}
function Ki(n, t) {
  return [y(x((u + t) / 2)), -n];
}
...
((Fi.invert = function (n, t) {
  for (
    ...
    ((u =
      (o =
        (i -= r =
          (i * (bi + Gi * o + u * (Oi + Ti * o)) - t) /
          (bi + 3 * Gi * o + u * (7 * Oi + 9 * Ti * o))) * i) *
      o *
      o),
    !(s(r) < e));
    ++a
  );
  return [(ki * n * (bi + 3 * Gi * o + u * (7 * Oi + 9 * Ti * o))) / g(i), N(m(i) / ki)];
}),
  (Ii.invert = mi(p)),
  (Yi.invert = function (n, t) {
    var r,
      e = t,
      o = 25;
    do {
      var u = e * e,
        a = u * u;
      e -= r =
        (e * (1.007226 + u * (0.015085 + a * (0.028874 * u - 0.044475 - 0.005916 * a))) - t) /
        (1.007226 + u * (0.045255 + a * (0.259866 * u - 0.311325 - 0.005916 * 11 * a)));
    } while (s(r) > i && --o > 0);
    return [
      n /
        (0.8707 +
          (u = e * e) * (u * (u * u * u * (0.003971 - 0.001529 * u) - 0.013791) - 0.131979)),
      e,
    ];
  }),
  (Di.invert = mi(N)),
  (Zi.invert = mi(function (n) {
    return 2 * p(n);
  })),
  (Ki.invert = function (n, t) {
    return [-t, 2 * p(d(n)) - u];
  }));
export {
  Ei as geoAlbers,
  yi as geoAlbersUsa,
  en as geoArea,
  wi as geoAzimuthalEqualArea,
  Mi as geoAzimuthalEqualAreaRaw,
  _i as geoAzimuthalEquidistant,
  xi as geoAzimuthalEquidistantRaw,
  kn as geoBounds,
  Kn as geoCentroid,
  ct as geoCircle,
  ...
  $i as geoConicConformal,
  Ai as geoConicConformalRaw,
  di as geoConicEqualArea,
  vi as geoConicEqualAreaRaw,
  Li as geoConicEquidistant,
  ji as geoConicEquidistantRaw,
  Yt as geoContains,
  Gt as geoDistance,
  Hi as geoEqualEarth,
  Fi as geoEqualEarthRaw,
  zi as geoEquirectangular,
  qi as geoEquirectangularRaw,
  Wi as geoGnomonic,
  Ii as geoGnomonicRaw,
  Ut as geoGraticule,
  ...
  jt as geoLength,
  Ri as geoMercator,
  Ni as geoMercatorRaw,
  Bi as geoNaturalEarth1,
  Yi as geoNaturalEarth1Raw,
  Ui as geoOrthographic,
  Di as geoOrthographicRaw,
  Vr as geoPath,
  pi as geoProjection,
  hi as geoProjectionMutator,
  ot as geoRotation,
  Ji as geoStereographic,
  Zi as geoStereographicRaw,
  j as geoStream,
  ni as geoTransform,
  Qi as geoTransverseMercator,
  Ki as geoTransverseMercatorRaw,
};
export default null;
