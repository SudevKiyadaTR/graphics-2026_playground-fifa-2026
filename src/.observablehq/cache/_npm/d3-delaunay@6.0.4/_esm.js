 ...
 */
import t from "../delaunator@5.1.0/_esm.js";
const e = 1e-6;
class i {
  constructor() {
  ...
  arc(t, i, n) {
    ...
    (null === this._x1
      ? (this._ += `M${s},${l}`)
      : (Math.abs(this._x1 - s) > e || Math.abs(this._y1 - l) > e) && (this._ += "L" + s + "," + l),
      n &&
        (this._ += `A${n},${n},0,1,1,${t - n},${i}A${n},${n},0,1,1,${(this._x1 = s)},${(this._y1 = l)}`));
  }
  rect(t, e, i, n) {
...
class s {
  ...
  _init() {
    ...
    let s, l;
    const h = (this.circumcenters = this._circumcenters.subarray(0, (i.length / 3) * 2));
  ...
  *cellPolygons() {
  ...
  _renderSegment(t, e, i, n, s) {
    ...
    0 === h && 0 === r
      ...
      : (l = this._clipSegment(t, e, i, n, h, r)) && (s.moveTo(l[0], l[1]), s.lineTo(l[2], l[3]));
  }
  contains(t, e, i) {
  ...
  *neighbors(t) {
  ...
  _cell(t) {
    ...
    do {
      ...
      if ((h.push(e[2 * i], e[2 * i + 1]), (r = r % 3 == 2 ? r - 2 : r + 1), s[r] !== t)) break;
      r = n[r];
    } while (r !== l && -1 !== r);
    return h;
  }
  ...
  _clipFinite(t, e) {
    ...
    if (r) ((h = u), (u = this._edgecode(r[0], r[1])), h && u && this._edge(t, h, u, r, r.length));
  ...
  _clipInfinite(t, e, i, n, s, l) {
    ...
    if (
      ...
      for (let e, i = 0, n = r.length, s = this._edgecode(r[n - 2], r[n - 1]); i < n; i += 2)
        ((e = s),
  ...
  _edge(t, e, i, n, s) {
    for (; e !== i; ) {
      ...
      (n[s] === i && n[s + 1] === l) || !this.contains(t, i, l) || (n.splice(s, 0, i, l), (s += 2));
    }
    return s;
  }
  _project(t, e, i, n) {
...
class c {
    ...
    return new c(
      "length" in t
        ? (function (t, e, i, n) {
            ...
            for (let h = 0; h < s; ++h) {
              const s = t[h];
              ((l[2 * h] = e.call(n, s, h, t)), (l[2 * h + 1] = i.call(n, s, h, t)));
            }
            return l;
          })(t, e, i, n)
        : Float64Array.from(
            (function* (t, e, i, n) {
              let s = 0;
              for (const l of t) (yield e.call(n, l, s, t), yield i.call(n, l, s, t), ++s);
            })(t, e, i, n)
          )
    );
  }
  ...
  _init() {
      ...
      (function (t) {
        ...
        for (let t = 0; t < e.length; t += 3) {
          const n = 2 * e[t],
            s = 2 * e[t + 1],
            l = 2 * e[t + 2];
          if ((i[l] - i[n]) * (i[s + 1] - i[n + 1]) - (i[s] - i[n]) * (i[l + 1] - i[n + 1]) > 1e-10)
            return !1;
        }
        return !0;
      })(e)
    ) {
      this.collinear = Int32Array.from({ length: i.length / 2 }, (t, e) => e).sort(
        (t, e) => i[2 * t] - i[2 * e] || i[2 * t + 1] - i[2 * e + 1]
      );
    ...
    s.length <= 2 &&
      ...
      (h[s[0]] = 1),
      2 === s.length && ((h[s[1]] = 0), (this.triangles[1] = s[1]), (this.triangles[2] = s[1])));
  }
  voronoi(t) {
    return new s(this, t);
  }
  *neighbors(t) {
    const { inedges: e, hull: i, _hullIndex: n, halfedges: s, triangles: l, collinear: h } = this;
    if (h) {
      const e = h.indexOf(t);
      return (e > 0 && (yield h[e - 1]), void (e < h.length - 1 && (yield h[e + 1])));
    }
    const r = e[t];
    if (-1 === r) return;
    let o = r,
  ...
  _step(t, e, i) {
    const { inedges: n, hull: s, _hullIndex: l, halfedges: r, triangles: o, points: a } = this;
    ...
    do {
      ...
      if ((g < u && ((u = g), (c = n)), (d = d % 3 == 2 ? d - 2 : d + 1), o[d] !== t)) break;
      if (((d = r[d]), -1 === d)) {
        if (
          ((d = s[(l[t] + 1) % s.length]),
  ...
  renderPoints(t, e) {
    (void 0 !== e || (t && "function" == typeof t.moveTo) || ((e = t), (t = null)),
      (e = null == e ? 2 : +e));
