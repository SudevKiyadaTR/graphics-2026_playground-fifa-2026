...
var r = Math.random,
  ...
  s = (function r(n) {
    ...
    function u(r, o) {
      ...
      if (0 === r) return () => 0;
      if (((o = null == o ? 1 : +o), 1 === r)) return () => -Math.log1p(-n()) * o;
      var u = (r < 1 ? r + 1 : r) - 1 / 3,
        a = 1 / (3 * Math.sqrt(u)),
            ...
            : function () {
                for (var u = 0, a = r, e = n; a * e > 16 && a * (1 - e) > 16; ) {
                  var i = Math.floor((a + 1) * e),
                    c = o(i, a - i + 1)();
                  c <= e ? ((u += i), (a -= i), (e = (e - c) / (1 - c))) : ((a = i - 1), (e /= c));
                }
                for (var f = e < 0.5, l = t(f ? e : 1 - e), s = l(), h = 0; s <= a; ++h) s += l();
                return u + (f ? h : a - h);
              }
      );
    }
  ...
  v = (function r(n) {
    function t(r, t, o) {
      var u;
      return (
        0 == (r = +r) ? (u = (r) => -Math.log(r)) : ((r = 1 / r), (u = (n) => Math.pow(n, r))),
        (t = null == t ? 0 : +t),
        (o = null == o ? 1 : +o),
        function () {
  ...
  g = (function r(n) {
    ...
    function u(r) {
      return function () {
        ...
        for (var c = -Math.log1p(-n()), f = 0; c <= a; ++f) c -= Math.log1p(-n());
        return u + f;
      };
    }
    return ((u.source = r), u);
