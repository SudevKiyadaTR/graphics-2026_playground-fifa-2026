...
function a(r) {
  ...
  return isNaN(r)
    ? "Invalid Date"
    : ((n = r.getUTCFullYear()) < 0 ? "-" + o(-n, 6) : n > 9999 ? "+" + o(n, 6) : o(n, 4)) +
        "-" +
        o(r.getUTCMonth() + 1, 2) +
        "-" +
        o(r.getUTCDate(), 2) +
...
function u(o) {
  ...
  function f(t, e) {
    ...
    function d() {
      ...
      if (34 === t.charCodeAt(a)) {
        for (; (f++ < u && 34 !== t.charCodeAt(f)) || 34 === t.charCodeAt(++f); );
        return (
          (e = f) >= u
            ? (s = !0)
            : 10 === (o = t.charCodeAt(f++))
    ...
    for (10 === t.charCodeAt(u - 1) && --u, 13 === t.charCodeAt(u - 1) && --u; (o = d()) !== n; ) {
  ...
  return {
    ...
    parseRows: f,
    format: function (r, n) {
      return (null == n && (n = e(r)), [n.map(l).join(o)].concat(c(r, n)).join("\n"));
    },
    ...
    if (o)
      if ("true" === o) o = !0;
        ...
        if (
          ...
          continue;
        (N && e[4] && !e[7] && (o = o.replace(/-/g, "/").replace(/T/, " ")), (o = new Date(o)));
      } else o = t;
    else o = null;
    r[n] = o;
  }
...
const N = new Date("2019-01-01T00:00").getHours() || new Date("2019-07-01T00:00").getHours();
export {
  j as autoType,
  s as csvFormat,
  l as csvFormatBody,
