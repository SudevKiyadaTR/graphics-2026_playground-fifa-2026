  ...
  function Qn(n, t) {
    return function (e) {
      ...
      for (e instanceof Date || (e = new Date(+e)); ++c < f; )
        37 === n.charCodeAt(c) &&
          (o.push(n.slice(a, c)),
          null != (u = C[(r = n.charAt(++c))]) ? (r = n.charAt(++c)) : (u = "e" === r ? " " : "0"),
          (i = t[r]) && (r = i(e, u)),
          o.push(r),
          (a = c + 1));
    ...
    return function (r) {
      ...
      if (
        ...
        ("W" in a || "U" in a) &&
          ...
          (c = "Z" in a ? g(s(a.y, 0, 1)).getUTCDay() : l(s(a.y, 0, 1)).getDay()),
          (a.m = 0),
          (a.d =
            "W" in a ? ((a.w + 6) % 7) + 7 * a.W - ((c + 5) % 7) : a.w + 7 * a.U - ((c + 6) % 7)));
      return "Z" in a ? ((a.H += (a.Z / 100) | 0), (a.M += a.Z % 100), g(a)) : l(a);
    };
  }
  function On(n, t, e, r) {
    for (var u, i, o = 0, c = t.length, a = e.length; o < c; ) {
      ...
      if (37 === (u = t.charCodeAt(o++))) {
        if (((u = t.charAt(o++)), !(i = Jn[u in C ? t.charAt(o++) : u]) || (r = i(n, e, r)) < 0))
          return -1;
...
function sn(n, t) {
  var e = n.getDay();
  return x((n = e >= 4 || 0 === e ? r(n) : r.ceil(n)).getFullYear() % 1e4, t, 4);
}
function hn(n) {
...
function Zn(n, t) {
  var e = n.getUTCDay();
  return x((n = e >= 4 || 0 === e ? a(n) : a.ceil(n)).getUTCFullYear() % 1e4, t, 4);
}
function Wn() {
  return "+0000";
}
...
function qn(n) {
  return ((y = h(n)), (v = y.format), (d = y.parse), (m = y.utcFormat), (D = y.utcParse), y);
}
qn({
  dateTime: "%x, %X",
  date: "%-m/%-d/%Y",
