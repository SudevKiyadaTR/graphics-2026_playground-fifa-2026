...
function w(t, n, e, r, i, o, u) {
  ...
  for (s = 0; s < f; ++s)
    (c = n[s]) &&
      ((p[s] = a = u.call(c, c.__data__, s, n) + ""), l.has(a) ? (i[s] = c) : l.set(a, c));
  for (s = 0; s < h; ++s)
    ((a = u.call(t, o[s], s, o) + ""),
      (c = l.get(a)) ? ((r[s] = c), (c.__data__ = o[s]), l.delete(a)) : (e[s] = new m(t, o[s])));
...
function D(t, n) {
  return t.style.getPropertyValue(n) || P(t).getComputedStyle(t, null).getPropertyValue(n);
}
function V(t) {
  return function () {
    delete this[t];
...
lt.prototype = ft.prototype = {
  ...
  select: function (t) {
    ...
    for (var n = this._groups, e = n.length, r = new Array(e), i = 0; i < e; ++i)
      for (var o, u, c = n[i], a = c.length, l = (r[i] = new Array(a)), f = 0; f < a; ++f)
        (o = c[f]) &&
  ...
  data: function (t, n) {
    ...
    for (
      var u = o.length, s = new Array(u), c = new Array(u), a = new Array(u), l = 0;
      l < u;
      ++l
    ) {
      var f = i[l],
  ...
  merge: function (t) {
    for (
      ...
      for (var a, l = e[c], f = r[c], h = l.length, p = (s[c] = new Array(h)), _ = 0; _ < h; ++_)
        (a = l[_] || f[_]) && (p[_] = a);
    for (; c < i; ++c) s[c] = e[c];
  ...
  sort: function (t) {
    ...
    for (var e = this._groups, r = e.length, i = new Array(r), o = 0; o < r; ++o) {
      for (var u, s = e[o], c = s.length, a = (i[o] = new Array(c)), l = 0; l < c; ++l)
        (u = s[l]) && (a[l] = u);
      a.sort(n);
    }
  ...
  style: function (t, n, e) {
    return arguments.length > 1
      ? this.each((null == n ? T : "function" == typeof n ? M : q)(t, n, null == e ? "" : e))
      : D(this.node(), t);
  },
...
function gt(t, n) {
  return (
    t.target && ((t = vt(t)), void 0 === n && (n = t.currentTarget), (t = t.touches || [t])),
