 ...
 */
import { dispatch as t } from "../d3-dispatch@3.0.1/_esm.js";
import { dragDisable as n, dragEnable as e } from "../d3-drag@3.0.0/_esm.js";
import { interpolateZoom as o } from "../d3-interpolate@3.0.1/_esm.js";
import { select as i, pointer as r } from "../d3-selection@3.0.0/_esm.js";
import { interrupt as u } from "../d3-transition@3.0.1/_esm.js";
var h = (t) => () => t;
...
function g() {
  ...
  function K(t, n) {
    return (n = Math.max(E[0], Math.min(E[1], n))) === t.k ? t : new a(n, t.x, t.y);
  }
  function S(t, n, e) {
    var o = n[0] - e[0] * t.k,
      i = n[1] - e[1] * t.k;
    ...
    t.on("start.zoom", function () {
      ...
      .tween("zoom", function () {
        var t = this,
          ...
          r = j(t, i).event(o),
          u = w.apply(t, i),
          h = null == e ? q(u) : "function" == typeof e ? e.apply(t, i) : e,
  ...
  function H(t, ...n) {
    if (x.apply(this, arguments)) {
      var e = j(this, n).event(t),
        o = this.__zoom,
        i = Math.max(E[0], Math.min(E[1], o.k * Math.pow(2, T.apply(this, arguments)))),
        h = r(t);
      if (e.wheel)
      ...
      (m(t),
        ...
        e.zoom("mouse", b(S(K(o, i), e.mouse[0], e.mouse[1]), e.extent, Y)));
    }
  }
  function N(t, ...o) {
    if (!k && x.apply(this, arguments)) {
      var h = t.currentTarget,
        s = j(this, o, !0).event(t),
        a = i(t.view)
          .on(
            "mousemove.zoom",
            function (t) {
              ...
              s.event(t).zoom(
                "mouse",
                b(S(s.that.__zoom, (s.mouse[0] = r(t, h)), s.mouse[1]), s.extent, Y)
              );
            },
            !0
          )
        ...
        l = t.clientX,
        p = t.clientY;
      (n(t.view), f(t), (s.mouse = [c, this.__zoom.invert(c)]), u(this), s.start());
    }
  }
  function O(t, ...n) {
    if (x.apply(this, arguments)) {
      var e = this.__zoom,
        ...
        s = b(S(K(e, h), o, u), w.apply(this, n), Y);
      (m(t),
        X > 0
          ? i(this).transition().duration(X).call(G, s, o, t)
          : i(this).call(I.transform, s, o, t));
    }
  }
  function W(t, ...n) {
    if (x.apply(this, arguments)) {
      var e,
        ...
        s = t.touches,
        a = s.length,
        c = j(this, n, t.changedTouches.length === a).event(t);
      for (f(t), o = 0; o < a; ++o)
        ((i = s[o]),
  ...
  function Z(t, ...n) {
    if (this.__zooming) {
      ...
      h.zoom("touch", b(S(o, i, u), h.extent, Y));
    }
  }
  function C(t, ...n) {
    if (this.__zooming) {
      ...
      if ((u.touch1 && !u.touch0 && ((u.touch0 = u.touch1), delete u.touch1), u.touch0))
        ...
        (u.end(), 2 === u.taps && ((o = r(o, this)), Math.hypot(g[0] - o[0], g[1] - o[1]) < P))
      ) {
  ...
  return (
    ...
    (I.scaleTo = function (t, n, e, o) {
      I.transform(
        t,
        function () {
          var t = w.apply(this, arguments),
            o = this.__zoom,
            i = null == e ? q(t) : "function" == typeof e ? e.apply(this, arguments) : e,
            r = o.invert(i),
            u = "function" == typeof n ? n.apply(this, arguments) : n;
          return b(S(K(o, u), i, r), t, Y);
        },
        e,
        o
      );
    }),
    (I.translateBy = function (t, n, e, o) {
      I.transform(
        t,
        function () {
          return b(
    ...
    (I.translateTo = function (t, n, e, o, i) {
      I.transform(
        t,
        function () {
          var t = w.apply(this, arguments),
            i = this.__zoom,
            r = null == o ? q(t) : "function" == typeof o ? o.apply(this, arguments) : o;
          return b(
            c
              .translate(r[0], r[1])
              .scale(i.k)
    ...
    (I.wheelDelta = function (t) {
      return arguments.length ? ((T = "function" == typeof t ? t : h(+t)), I) : T;
    }),
    (I.filter = function (t) {
      return arguments.length ? ((x = "function" == typeof t ? t : h(!!t)), I) : x;
    }),
    (I.touchable = function (t) {
      return arguments.length ? ((M = "function" == typeof t ? t : h(!!t)), I) : M;
    }),
    (I.extent = function (t) {
    ...
    (I.scaleExtent = function (t) {
      return arguments.length ? ((E[0] = +t[0]), (E[1] = +t[1]), I) : [E[0], E[1]];
    }),
    ...
    (I.clickDistance = function (t) {
      return arguments.length ? ((D = (t = +t) * t), I) : Math.sqrt(D);
    }),
    (I.tapDistance = function (t) {
