...
function ce(r, e, t, o) {
  ...
  return (
    ...
    new (t || (t = Promise))(function (n, u) {
      ...
      (O(l, "h"), p(l, "step"), l((o = o.apply(r, e || [])).next()));
    })
  );
}
    ...
    for (; u && ((u = 0), l[0] && (t = 0)), t; )
      try {
        if (
          ...
          i &&
            (n =
              l[0] & 2 ? i.return : l[0] ? i.throw || ((n = i.return) && n.call(i), 0) : i.next) &&
            !(n = n.call(i, l[1])).done)
        )
          return n;
        switch (((i = 0), n && (l = [l[0] & 2, n.value]), l[0])) {
          ...
          default:
            if (
              ((n = t.trys), !(n = n.length > 0 && n[n.length - 1]) && (l[0] === 6 || l[0] === 2))
            ) {
              t = 0;
              continue;
            }
...
var ke = "ENTRIES",
  ...
  Y = (function () {
    ...
    return (
      ...
      (r.prototype.value = function () {
        return J(this._path).node.get(L);
      }),
          ...
          for (var m = n, v = 0; v < f.length; ++v, ++m) {
            for (
              ...
              var S = F !== e[x],
                ...
                z = i[g + x + 1] + 1,
                D = i[w + x] + 1,
                b = (i[w + x + 1] = Math.min(C, z, D));
              b < E && (E = b);
            }
            if (E > t) continue e;
          }
          ve(r.get(f), e, t, o, i, m, u, a + f);
        }
      }
    } catch (T) {
      s = { error: T };
  ...
  X = (function () {
    ...
    return (
      ...
      (r.prototype.delete = function (e) {
        return ((this._size = void 0), De(this._tree, e));
      }),
  ...
  Te = (function () {
    function r(e) {
      ...
      ((this._options = I(I(I({}, oe), e), {
        ...
        autoSuggestOptions: I(I({}, qe), e.autoSuggestOptions || {}),
      })),
        (this._index = new X()),
    ...
    return (
                ...
                for (var x = ((i = void 0), _(E)), S = x.next(); !S.done; S = x.next()) {
                  ...
                  if (Array.isArray(z))
                    try {
                      ...
                      try {
                        b && !b.done && (a = D.return) && a.call(D);
                      } finally {
                        if (u) throw u.error;
                      }
                    }
                  else z && this.addTerm(A, m, z);
                }
              } catch (k) {
                i = { error: k };
              } finally {
                try {
                  S && !S.done && (n = x.return) && n.call(x);
                } finally {
                  if (i) throw i.error;
                }
              }
      ...
      (r.prototype.remove = function (e) {
        ...
        (this._storedFields.delete(m),
          this._documentIds.delete(m),
          this._idToShortId.delete(y),
          this._fieldLength.delete(m),
      ...
      (r.prototype.discard = function (e) {
        ...
        if (o == null)
          throw new Error(
            "MiniSearch: cannot discard document with ID ".concat(e, ": it is not in the index")
          );
      ...
      (r.prototype.performVacuuming = function (e, t) {
        return ce(this, void 0, void 0, function () {
          ...
          return he(this, function (b) {
            switch (b.label) {
              case 0:
                if (((o = this._dirtCount), !this.vacuumConditionsMet(t))) return [3, 10];
                ((i = e.batchSize || ie.batchSize),
                  (n = e.batchWait || ie.batchWait),
                  (u = 1),
                  (b.label = 1));
              case 1:
                (b.trys.push([1, 7, 8, 9]), (a = _(this._index)), (s = a.next()), (b.label = 2));
              case 2:
                if (s.done) return [3, 6];
                ((l = V(s.value, 2)), (c = l[0]), (h = l[1]));
                try {
                  for (d = ((S = void 0), _(h)), f = d.next(); !f.done; f = d.next()) {
                    ((y = V(f.value, 2)), (m = y[0]), (v = y[1]));
                    try {
                      for (F = ((z = void 0), _(v)), w = F.next(); !w.done; w = F.next())
                        ((g = V(w.value, 1)),
                          (E = g[0]),
                          !this._documentIds.has(E) && (v.size <= 1 ? h.delete(m) : v.delete(E)));
                    } catch (T) {
                      z = { error: T };
                    } finally {
                      try {
                        w && !w.done && (D = F.return) && D.call(F);
                      } finally {
                        if (z) throw z.error;
                      }
                    }
              ...
              case 6:
                return [3, 9];
              case 7:
                return ((A = b.sent()), (M = { error: A }), [3, 9]);
              case 8:
                try {
                  s && !s.done && (x = a.return) && x.call(a);
                } finally {
                  if (M) throw M.error;
                }
                return [7];
              case 9:
                ((this._dirtCount -= o), (b.label = 10));
              case 10:
                return [4, null];
              case 11:
                return (
        ...
        try {
          for (var v = _(a), F = v.next(); !F.done; F = v.next()) {
            var w = V(F.value, 2),
              ...
              d = g.terms,
              E = g.count;
            m.push({ suggestion: y, terms: d, score: h / E });
          }
        } catch (A) {
          n = { error: A };
        } finally {
          try {
            F && !F.done && (u = v.return) && u.call(v);
          } finally {
            if (n) throw n.error;
          }
        }
      ...
      (r.loadJS = function (e, t) {
        var o,
          ...
          f = e.fieldIds,
          y = e.fieldLength,
          m = e.averageFieldLength,
          v = e.storedFields,
          F = e.dirtCount,
          w = e.serializationVersion;
        if (w !== 1 && w !== 2)
          throw new Error(
      ...
      (r.prototype.executeQuery = function (e, t) {
        ...
        var u = this._options,
          ...
          s = u.processTerm,
          l = u.searchOptions,
          c = I(I({ tokenize: a, processTerm: s }, l), t),
          h = c.tokenize,
          d = c.processTerm,
          f = h(e)
            .flatMap(function (v) {
      ...
      (r.prototype.executeQuerySpec = function (e, t) {
        var o,
          ...
          F = this.termResults(e.term, e.term, 1, v, s, l, d),
          w,
          g;
        ...
        if (w)
          try {
            for (var M = _(w), x = M.next(); !x.done; x = M.next()) {
              var S = V(x.value, 2),
                C = S[0],
                z = S[1],
              ...
              if (D) {
                g?.delete(C);
                var b = (m * C.length) / (C.length + 0.3 * D);
                this.termResults(e.term, C, b, z, s, l, d, F);
              }
            }
          } catch (P) {
            o = { error: P };
        ...
        if (g)
          try {
            for (var T = _(g.keys()), k = T.next(); !k.done; k = T.next()) {
              var C = k.value,
                q = V(g.get(C), 2),
                j = q[0],
                D = q[1];
              if (D) {
                var b = (y * C.length) / (C.length + D);
                this.termResults(e.term, C, b, j, s, l, d, F);
              }
            }
          } catch (P) {
            n = { error: P };
        ...
        for (var i = _(e.keys()), n = i.next(); !n.done; n = i.next()) {
          ...
          if (a == null) r.set(u, e.get(u));
            ...
            var s = e.get(u),
              ...
              c = s.terms,
              h = s.match;
            ((a.score = a.score + l), (a.match = Object.assign(a.match, h)), _e(a.terms, c));
          }
        }
      } catch (d) {
        t = { error: d };
        ...
        for (var n = _(e.keys()), u = n.next(); !u.done; u = n.next()) {
          ...
          if (s != null) {
            var l = e.get(a),
              ...
              d = l.match;
            (_e(s.terms, h),
              i.set(a, { score: s.score + c, terms: s.terms, match: Object.assign(s.match, d) }));
          }
        }
      } catch (f) {
        t = { error: f };
  ...
  oe = {
    idField: "id",
    extractField: p(function (r, e) {
      return r[e];
    }, "extractField"),
    tokenize: p(function (r) {
      return r.split(Pe);
    }, "tokenize"),
    processTerm: p(function (r) {
...
const Re = await fetch(import.meta.resolve("./minisearch.json"))
  ...
  .then((r) =>
    Te.loadJS(r, {
      ...r.options,
      searchOptions: { boostDocument: W((e) => (be(e) ? 1 / 3 : 1), "boostDocument") },
      processTerm: W(
        (e) =>
          e
            .slice(0, 15)
...
$.addEventListener("input", () => {
  if (H === $.value) return;
  if (((H = $.value), !H.length)) {
    (G.setAttribute("data-shortcut", $e),
      xe.classList.remove("observablehq-search-results"),
      (se.innerHTML = ""));
    return;
  }
  (G.setAttribute("data-shortcut", ""), xe.classList.add("observablehq-search-results"));
  const r = Re.search(H, { boost: { title: 4, keywords: 4 }, fuzzy: 0.15, prefix: !0 });
  se.innerHTML =
    r.length === 0
      ? "<div>no results</div>"
      : `<div>${r.length.toLocaleString("en-US")} result${r.length === 1 ? "" : "s"}</div><ol>${r.map(Se).join("")}</ol>`;
});
function be(r) {
  return /^\w+:/.test(r);
}
(O(be, "f"), W(be, "isExternal"));
function Se({ id: r, score: e, title: t }, o) {
  const i = /^\w+:/.test(r);
  return `<li data-score="${Math.min(5, Math.round(0.6 * e))}" class="observablehq-link${o === 0 ? ` ${K}` : ""}"><a href="${Ee(i ? r : import.meta.resolve(`..${r}`))}"${i ? ' target="_blank"' : ""}><span>${Ae(String(t ?? "\u2014"))}</span></a></li>`;
}
(O(Se, "g"), W(Se, "renderResult"));
function Ee(r) {
  return r.replace(/["&]/g, le);
}
(O(Ee, "q"), W(Ee, "escapeDoubleQuote"));
function Ae(r) {
  return r.replace(/[<&]/g, le);
}
(O(Ae, "S"), W(Ae, "escapeText"));
function le(r) {
...
(O(le, "b"),
  ...
  $.addEventListener("keydown", (r) => {
    const { code: e } = r;
    if (e === "Escape" && $.value === "") return $.blur();
    if (e === "ArrowDown" || e === "ArrowUp" || e === "Enter") {
      const t = se.querySelector("ol");
      if (!t) return;
      let o = t.querySelector(`.${K}`);
      if (e === "Enter") {
        const i = o.querySelector("a");
        (/Mac|iPhone/.test(navigator.platform) ? r.metaKey : r.ctrlKey)
          ? open(i.href, "_blank")
          : i.click();
        return;
      }
      (o.classList.remove(K),
        e === "ArrowUp"
