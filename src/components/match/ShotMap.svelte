<script>
  ...
  const allShots = shotEvents.map(e => {
      ...
      // Period 5 = 2nd half, Period 9 = 2nd extra-time half; teams swap ends so flip both axes to normalize
      const isSecondHalf = e.Period === 5 || e.Period === 9;
  ...
  <svg class="Opta-Responsive-Svg Opta-selectable-area" preserveAspectRatio="xMidYMid meet" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 843.2 552.8">
    <g class="Opta-Field" transform="translate(20.8,12.8)">
      <g class="Opta-Markings">
        ...
        <path d="M0,413.436L125.714,413.436L125.714,110.564L0,110.564"></path>
        <path d="M800,413.436L674.286,413.436L674.286,110.564L800,110.564"></path>
        <path d="M0,331.168L41.905,331.168L41.905,192.832L0,192.832"></path>
        <path d="M800,331.168L758.095,331.168L758.095,192.832L800,192.832"></path>
        ...
        <path d="M33.714,-61.02290556782137A69.71677559912854,69.71677559912854 0 0,1 33.714,61.02290556782137L33.714,61.02290556782137A69.71677559912854,69.71677559912854 0 0,0 33.714,-61.02290556782137Z" transform="translate(92,262)"></path>
        <path d="M-33.714,61.02290556782137A69.71677559912854,69.71677559912854 0 0,1 -33.714,-61.02290556782137L-33.714,-61.02290556782137A69.71677559912854,69.71677559912854 0 0,0 -33.714,61.02290556782137Z" transform="translate(708,262)"></path>
      </g>
